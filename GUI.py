...
mainwind.iconbitmap(
    "D:\python files\house-insurance.ico")
...
def ca(list):
    ...
    lb = Label(fr2, font=('VEXA', 12,), text='الــوصــيـــه',
               fg='#fed049', bg='#3d5656')
    lb.place(x=680, y=y)
    lb = Label(fr2, font=('VEXA', 12, 'bold'),
               text=will, fg='white', bg='#3d5656')
    lb.place(x=x - 70, y=y)
